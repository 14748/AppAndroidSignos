...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pal.add(new Palabra("crecer-planta", "aumentar de tamaño en plantas", R.drawable.crecer_planta, Verbos));
        ...
        pal.add(new Palabra("hablar-lse", "comunicarse usando lenguaje de señas", R.drawable.hablar_lse, Verbos));
        pal.add(new Palabra("hablar-oral", "comunicarse verbalmente", R.drawable.hablar_oral, Verbos));
        pal.add(new Palabra("jugar", "realizar actividades recreativas", R.drawable.jugar, Verbos));
        pal.add(new Palabra("lavar-la-cabeza", "limpiar el pelo y cuero cabelludo", R.drawable.lavar_la_cabeza, Verbos));
        pal.add(new Palabra("lavar-la-ropa", "limpiar las prendas de vestir", R.drawable.lavar_la_ropa, Verbos));
        pal.add(new Palabra("lavar-los-dientes", "limpiar los dientes con cepillo", R.drawable.lavar_los_dientes, Verbos));
        ...
        pal.add(new Palabra("no-conocer", "no tener noticia de algo", R.drawable.no_conocer, Verbos));
        pal.add(new Palabra("no-gustar", "sentir desagrado por algo", R.drawable.no_gustar, Verbos));
        pal.add(new Palabra("no-tener", "carecer de algo", R.drawable. no_tener, Verbos));
        ...
        pal.add(new Palabra("vamos-a", "propuesta de ir a un lugar", R.drawable.vamos_a, Verbos));
        ...
        pal.add(new Palabra("dia-manana", "el día que sigue al presente", R.drawable.dia_manana, DiasSemana));
        pal.add(new Palabra("domingo", "séptimo y último día de la semana", R.drawable.domingo, DiasSemana));
        pal.add(new Palabra("fin-de-semana", "periodo que comprende sábado y domingo", R.drawable.fin_de_semana, DiasSemana));
        ...
        pal.add(new Palabra("lenguajessignosespañola", "sistema de comunicación mediante signos para personas sordas", R.drawable.lenguajessignosespanola, Colegio));
